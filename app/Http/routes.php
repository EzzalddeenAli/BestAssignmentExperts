...
Route::post('/handlePlagiUpload','filecontroller@handlePlagiUpload');
Route::post('/deletePlagiUpload','filecontroller@deletePlagiUpload');
...
/*all new content url*/
    ...
    Route::get('/essay-help-from-the-expert-writers-in-sydney', function () {
