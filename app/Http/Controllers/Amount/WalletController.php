   ...
   public function addAmountInWallet($id,$addAmountInWallet,$extraParam='')
   {
    ...
    {      
       ...
       $get_referral=DB::table('user_referral')->where('uid',$user_id)->first();
         if($get_referral) {
          $unique_referral = $get_referral->referral_code;
         }
         else{
                $unique_referral ='No referral code is available, please contact to the site administrator .';
                     }
