    ...
    $wallet_with_partial_and_full_data  = isset($_REQUEST['custom'])?$_REQUEST['custom']:'';
       ...
       try
        { 
               ...
               //       dd($email);       
                    $send_mail['send_to']   = $email;
                    $send_mail['name']      = $name;
                    $send_mail['subject']   = "Thank for you ordering with Best Assignment Experts";
                    $send_mail_array[]=$send_mail;
                   $variables['welcome_name']  =$name;
                    $variables['welcome_email']  =  $email;
                    $variables_array[]=$variables;

                     $notification->sendMail($send_mail_array, 'emails.thanku', $variables_array);
