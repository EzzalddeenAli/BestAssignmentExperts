...
class CouponController extends Controller 
{
     ...
     {
         //This will be on submit of create  on coupon page
        ...
        $coupon_max_red=Input::get('coupon_redemption');
        $coupon_max_red_per_user= Input::get('coupon_redemption_per_user');
    ...
    public function editCoupons($id)
     {
        $couponData = DB::table('coupons')->where('id', '=', $id)->get();
        //dd('Hiii');
        return View('admin.dashboard.edit-coupons')->with('coupon', $couponData);
         
     } 

     public function updateCouponData(Request $request)
     {
        $id =  $request->id;
        ...
        $coupon_expiry= strtotime($request->coupon_expiry);
        $coupon_max_red=$request->coupon_redemption;
        $coupon_max_red_per_user= $request->coupon_redemption_per_user;
     ...
     $coupon_discount_data=$coupon_discount;
        ...
        else
       {
        ...
        DB::table('coupons')->where('id', '=', $id)->update(['coupon_type'=>$coupon_name,'coupon_code'=>$coupon_code,'discount_type'=>$coupon_discount, 'coupon_discount_value'=>$coupon_discount_value, 'coupon_expiry'=>$coupon_expiry, 'max_redemption'=>$coupon_max_red, 'max_redemption_per_user'=>$coupon_max_red_per_user]); 
