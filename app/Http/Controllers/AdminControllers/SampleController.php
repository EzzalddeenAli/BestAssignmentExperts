...
class SampleController extends Controller 
{
     ...
     public function insertSample(Request $request)
     {
        ...
        DB::table('samples')->insert(['title'=>$request->topic,'short_desc'=>$request->short_description,'content'=>$request->content,'time'=>time(), 'page_title_tag'=>$request->page_title_tag,'page_meta_tag'=>$request->page_meta_tag ]);
