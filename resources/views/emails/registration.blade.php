                                              ...
                                              <div class="column" style="display:inline-block;vertical-align:top;">
                                                <table class="contents" style="border-spacing:0; width:100%"  bgcolor="#ffffff" >
                                                  <tr>
                                                    ...
                                                    <a href="https://www.bestassignmentexperts.com/" target="_blank"><img src="https://bestassignmentexperts.com/uploads/logo.jpg" class="img1" width="150" height="70" alt="" style="border-width:0; display:none;"/><img src="https://bestassignmentexperts.com/uploads/email.png" class="img2" alt="" style="border-width:0;"/></a></td>
                                                  </tr>
                                                </table>
                                              </div>
                ...
                <table class="one-column" border="0" cellpadding="0" cellspacing="0" width="100%" style="border-spacing:0" bgcolor="#FFFFFF">
                  <tr>
                    ...
                    <p style="color:#000; font-size:15px; text-align:left; font-weight:bold; font-family: Verdana, Geneva, sans-serif"> 
                         <h3>Welcome, <span style="color:#000;">
                               
                   @foreach($key as $value){{$value['welcome_name']}}</p>
                    <p style="color:#000; font-size:14px; text-align:left; font-weight:400; font-family: Verdana, Geneva, sans-serif">                              
                 You have registered successfully. Thank you for choosing us. We sincerely hope to serve you well.<br><br>   
                 <strong style="color:#000;">Your Referral code is:{{$value['referral_code']}}</strong><br></p>
                       <p style="color:#000; font-size:14px; text-align:left; font-weight:400; font-family: Verdana, Geneva, sans-serif">                               
                   Steps to use this code :
                   </p>
                         @endforeach
                   <p style="color:#000; font-size:14px; text-align:justify; font-family: Verdana, Geneva, sans-serif">
                           
                            <strong>*</strong>
                         &nbsp;&nbsp; Invite friends using referral code.<br>
                         
                   <strong>*</strong> &nbsp; &nbsp;Visit our websites.</P>
                   
                       <p style="color:#000; font-size:14px;font-family: Verdana, Geneva, sans-serif">
