                  ...
                  <tr>
                    <td align="left" style="padding:0px 40px 40px 40px"><p style="color:#000; font-size:15px; text-align:left; font-weight:bold; font-family: Verdana, Geneva, sans-serif"> 
                      ...
                      <p style="color:#5b5f65; font-size:14px; text-align:justify; font-family: Verdana, Geneva, sans-serif">
                                                   Dear {{$value['welcome_name']}},</p>

            Your plagi order has been placed successfully.We are delighted to serve you.<br><br>
            <strong style="color:#000;">Your Plagi Order ID is :          {{$value['order_id']}} </strong><br>
            <strong style="color:#000;">Unique Referral ID is :   {{$value['referral_code']}} </strong><br>
            <strong style="color:#000;">Your Login password is :   {{$value['password']}} </strong>
            </p>
                       <p style="color:#5b5f65; font-size:14px; text-align:justify; font-family: Verdana, Geneva, sans-serif">
                             
                    <strong style="color:#000;">Offer for you: </strong> Order another plagi assignment within 24 hours and get 20% off on another plagi assignment.
