            ...
            <tr>
              <td style="padding-top:0;padding-bottom:0;padding-right:0;padding-left:0;"><!-- ======= start header ======= -->
                ...
                <table class="one-column" border="0" cellpadding="0" cellspacing="0" width="100%" style="border-spacing:0" bgcolor="#FFFFFF">
                  <tr>
                    <td align="left" style="padding:0px 40px 40px 40px"><p style="color:#000; font-size:15px; text-align:left; font-weight:bold; font-family: Verdana, Geneva, sans-serif">         @foreach($key as $value)                   
                    Dear {{$value['welcome_name']}},</p>
                      
                       
                      <p style="color:#5b5f65; font-size:14px; text-align:justify; font-family: Verdana, Geneva, sans-serif">
                             Thank for you ordering with "Best Assignment Experts".
               We would be happy to serve you more.</br>
            </br> You can use code  <b style="color:black;"> BAE15 </b>  to avail the 15% discount on your second order.
                        </p>
