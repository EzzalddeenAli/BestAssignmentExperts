            ...
            <div class="login-block" style="max-width:550px;">                   
                ...
                <div >
                    ...
                    <table class ="table" >
                        ...
                        <h1 class="well text-center" style="margin-top:10px;margin-bottom:20px;font-size: 25px;">Enter Your Registered Email Address</h1>
                        <hr>
                        ...
                        <tr>
                            <td colspan="2">
                                <button type="submit"  class="button-fullwidth cws-button bt-color-3 border-radius">Password Reset Link</button>
