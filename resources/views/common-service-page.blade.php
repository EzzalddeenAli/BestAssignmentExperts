   ...
   <script src="https://code.jquery.com/jquery-1.11.3.js"></script>
    ...
    <section class="signup-placeorder fullwidth-background bg-2" >
        <div class="grid-row">
            <div class="login-block">
                ...
                <form class="login-form" ng-if="showPlaceOrderForm == 'true'">
                    ...
                    <button ng-click="placeOrderDetails(place_order, count)" class="button-fullwidth cws-button bt-color-3 border-radius submit-cws">Submit</button>
                </form>
                ...
                <form class="login-form" name="place-order-signup" ng-if="showPlaceOrderForm != 'true'" action="/create-user-from-place-order-page" method="POST" enctype="multipart/form-data" novalidate="">
                    <div class="form-group file">
                        <input type="file" class="login-input file-upload" placeholder="Choose a File" name="uploaded_file1" required="">
                        <!-- <span class="input-icon">
                            <i class="fa fa-envelope-o"></i>
                        </span> -->
                    </div>
                  ...
                  <select name="country_code" value="{{ Input::old('country_code') }}" class="setheight dara form-control select-height" ng-init="initialize()"> 
                ...
                <input type="text" class="col-sm-3 data phone-code" name="phone_code" value="{{(Input::old('country_code')) ? Input::old('country_code'):"+1" }}" readonly="readonly"/>
                ...
                <input type="text"  class="login-input" placeholder="Enter Phone Number" name="phone" ng-model="order.phone" required="" numbers-only >
                    ...
                    <div class="form-group">               
                        <textarea type="text" class="login-input place-textarea" placeholder="Description" name="description" ng-model="order.description" required=""> </textarea>                      
                            ...
                            <button type="submit" class="button-fullwidth cws-button bt-color-3 border-radius submit-cws">Sign Up</button>
                            <!--<button ng-click="back()" class="button-fullwidth cws-button bt-color-3 border-radius">Back</button>-->
                        
                </form>
                  <button ng-click="back()" class="button-fullwidth cws-button border-radius submit-cws" ng-if="showPlaceOrderForm != 'true'">Back</button>
		...
		<div class="carousel-reviews broun-block">
                ...
                <div class="carousel-inner">
                    <div class="item active">
        				...
        				<p>Its been Really Wonderful to use Assignment Service,Will definitely come back for more assignment.</p>
					            <ins class="ab zmin sprite sprite-i-triangle block"> 
								<img src="theme/img/images/Testimonials/john.jpg" class="img-circle" alt=""/></ins>
				            </div>
							<div class="person-text rel">
						...
						<div class="col-md-4 col-sm-6 hidden-sm hidden-xs">
    						...
    						<p>	Best Assignment Experts is Quick and effective service, On time and great content.Thanks for helping me and certailny use the service again.</p>
								<ins class="ab zmin sprite sprite-i-triangle block">
								  <img src="theme/img/images/Testimonials/darren.jpg" class="img-circle" alt=""/>
								</ins>
							</div>
							<div class="person-text rel">
          ...
          <p> Wonderful experience with “BestAssignmentExperts.com”. Will be back with another work.</p>
							    <ins class="ab zmin sprite sprite-i-triangle block">
								  <img src="theme/img/images/Testimonials/adamaris.jpg" class="img-circle" alt=""/>
								</ins>
					        </div>
							<div class="person-text rel">
               ...
               <p>  Its been Really Wonderful to use Assignment Service,Will definitely come back for more assignment.</p>
					            <ins class="ab zmin sprite sprite-i-triangle block">
				               <img src="theme/img/images/Testimonials/john.jpg" class="img-circle" alt=""/>
								</ins>
				            </div>
							<div class="person-text rel">
     ...
     @include('layout.common-services-footer') 
