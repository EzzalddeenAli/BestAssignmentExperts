            ...
            <tr>
              <td style="padding-top:0;padding-bottom:0;padding-right:0;padding-left:0;"><!-- ======= start header ======= -->
                  ...
                  <tr>
                    <td><table style="width:100%;" cellpadding="0" cellspacing="0" border="0">
                        <tbody>
                          ...
                          <a href="https://www.bestassignmentexperts.com/" target="_blank"><img src="https://bestassignmentexperts.com/uploads/logo.jpg" class="img1" width="150" height="70" alt="" style="border-width:0;"/><img src="https://bestassignmentexperts.com/uploads/email.png" class="img2" alt="" style="border-width:0;"/></a></td>
                                                  </tr>
                                                </table>
                                              </div>
                          ...
                          <![endif]--></td>
                                          ...
                                          <tr>
                                            <td align="center" style="padding-left:40px"><table border="0" cellpadding="0" cellspacing="0" style="border-bottom:2px solid #ff7e65" align="center">
                ...
                <table class="one-column" border="0" cellpadding="0" cellspacing="0" width="100%" style="border-spacing:0" bgcolor="#FFFFFF">
                  <tr>
              <td>&nbsp;</td>
                    <td align="center" style="padding:18px 40px 40px 40px">
          
          <p style="color:#000; font-size:15px; text-align:center; font-weight:bold; font-family: Verdana, Geneva, sans-serif"> 
                         Thank You!</p>
                      <p style="color:#000; font-size:14px; text-align:center; font-family: Verdana, Geneva, sans-serif">
                              Your order has been placed successfully. Further You can check the order details through your dashboard.
               
                        </p>
                       <p>
                            
                <a href="/my-orders" style="background-color:#ff5722;border-radius:4px;color:#ffffff;display:inline-block;font-family:Helvetica, Arial, sans-serif;font-size: 14px;text-align:center;text-decoration:none;width: 114px;padding-top: 9px;height: 26px;">
              View Your Order</a>
                                ...
                                <tbody>
                                  <tr>
                                    <td align="center"><table border="0" cellpadding="0" cellspacing="0" style="Margin:0 auto;">
                                        <tbody><tr>
                    <td align="center"><img src="http://pngc.mypng.cn/2246/dashboard-icon.png.1.png" width="78" height="78" alt="meter image"></td>
                    </tr>
                    <tr>
                    <td>
                                         <a href="/my-orders" style="background-color:#ff5722;border-radius:4px;color:#ffffff;display:inline-block;font-family:Helvetica, Arial, sans-serif;font-size: 14px;text-align:center;text-decoration:none;width: 123px;padding-top:10px;height:28px;">
               Go To Dashboard</a>
               </td>
                                        </tr>
                                      </tbody></table></td>
      ...
      <tr>
        <td align="center" bgcolor="#ff7e65" class="one-column" style="padding-top:0;padding-bottom:0;padding-right:0;padding-left:0;"><table width="150" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td width="33" align="center"><a href="https://plus.google.com/u/0/105218237372273771771" target="_blank"><img src="https://www.vertexfinancial.com/wp-content/themes/vertexfinancial/images/google_plus_footer.png" alt="google-plus" width="32" height="32" border="0"/></a></td>
          </tr>
        </table></td>
      </tr>
      <tr>
