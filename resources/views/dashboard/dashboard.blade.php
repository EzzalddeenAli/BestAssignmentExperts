    ...
    <section class="content">
      ...
      <div class="row">
        ...
        <div class="box box-info">
            ...
            <div class="box-footer clearfix">
              <a href="/add-assignment" class="btn btn-sm btn-info btn-flat pull-left" style="padding: 10px; font-size: 17px;">Place New Order</a>
              <a href="/my-assignment" class="btn btn-sm btn-default btn-flat pull-right" style="padding: 10px; font-size: 17px;">View All Orders</a>
            </div>
