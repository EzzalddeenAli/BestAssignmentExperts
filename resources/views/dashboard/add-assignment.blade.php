                    ...
                    <form action="<?= URL::to('/put/assignment/data') ?>" name="add-assignment" method="POST" class="form-horizontal" enctype="multipart/form-data">
                        <div class="box-body">
                            ...
                            <div class="form-group col-sm-6">
                                ...
                                <label "inputEmail3"  class="col-sm-4 control-label">Subject</label>

                                <div class="col-sm-8">
                                    <input type="text" name="subject" class="form-control select2" id="reqSubject" placeholder="Subject" style="width: 100%;">
							 ...
							 <div class="form-group col-sm-6">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <div class="input-group date" style="width:100%">
                                            ...
                                            <input type="number" name="no_of_pages" class="form-control pull-right input-group" id="regNoOfPages" placeholder="Enter No. of Pages">
							 ...
							 <div class="form-group col-sm-6">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <div class="input-group date">
                                        ...
                                        <div class="input-group-addon input-icon" style="padding: 0; padding-left: 4px;">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10 pding_right left_1">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10 pding_right left_1">
                                    ...
                                    <div class="input-group date">
                                        ...
                                        <input type="file" required="" name="uploaded_file1[]" id="UploadAssignment1" class="form-control add_upload" placeholder="Browse Assignment" multiple="true">
