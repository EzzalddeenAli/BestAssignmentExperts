...
<html lang="en">
<head>
<title>Frequently Asked Questions | Online Assignment Solutions by Experts</title>
<meta name="description" content="Academic Writing Services frequently asked questions from Best Assignment Experts">
<meta name="keywords" content="FAQ, Very frequently asked questions"/>
				...
				<div class="grid-col grid-col-9">
					<section class="padding-top-none">
						...
						<div class="accordions">
							...
							<!--/content-title -->
							<!-- accordions content -->
							<div class="content">In case if student does not get satisfied, we provide refund or rework as requested from the side of the student. If the student opts for rework, then the cycle will repeat until the student gets fully satisfied.
                           </div>
							<!--/accordions content -->
						</div>
						<!-- accordions -->
