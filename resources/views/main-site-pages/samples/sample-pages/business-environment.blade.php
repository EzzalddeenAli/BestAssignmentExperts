			...
			<div class="grid-col grid-col-9">
				...
				<main>
					<section class="clear-fix">
						...
						<p class="fs-18"><strong>                                             Business Environment
						...
						<p>	The purpose of this report is to examine the business environment of a real organization and provide recommendations for the business based on the analysis. The analysis of the environment in which any business operates is vital for the marketers due to the fact that it helps them determine the strengths, weaknesses and opportunities. The strategic decisions for the business can only be taken when marketer is well-versed with the strengths and weaknesses. The report takes into consideration different cases to explain the significance of the business environment. 
						...
						<p style="color: red">(Not all the categories, but one organization with any type I choice this one but please put more work on purpose.)</p>

						<p class="fs-18"><strong>                                             Task 1 : 1.2    Describe the extent to which Primark meets the objectives of its different stakeholders
						...
						<ul>
						<li><strong>Investors :</strong> Primark needs to have investors who provide the organization with risk capital. The advisors of the investors are concerned with having information that will help them determine why they should invest in the organization. As such, Primark is always available to issue the investors with any required information that will allow them to enable them to assess the ability of the firm to pay the dividends. 
						
						</li>

						<li><strong>Employees  :</strong> Employees are also stakeholders in the company. The employees are always interested in the information about the sustainability and profitability of the employer. Primark has been well aware of the needs of the employees and it has been more reliable in offering all the staff with a desirable remuneration. 
						
						</li>

						<li><strong>Suppliers  :</strong> Suppliers are also other stakeholders at Primark. The organization has been making efforts to meet the objectives of providers through paying off all the amounts for the raw materials and other debts owed to the vendors. As such, the provider as a stakeholder will be able to meet the objectives and make its mission a success. 
						
						</li>


						<li><strong>The ethical trading initiative :</strong> The ethical trading initiative is another stakeholder at Primark. The union has to be sure of a continued relation with the enterprise considering they have a long term relationship. In its case, Primark has stood to show its commitment and has thus been able to prove to the union that it will be meeting its objectives. 
                        ...
                        <br>
					     ...
					     <p class="fs-18"><strong> Task 1: 1.3 Explain the responsibilities of Primark as an organization and the strategies employed to meet them
                        </strong></p>
						<p>
						...
						<ul>
							...
							<li>
								In its environmental responsibilities, Primark has been on the forefront to make sure that the environment is well taken care of and is safe. The organization has ensured that it reports its supplier’s discharge of the hazardous chemicals. (What strategies they using to meet the responsibilities, employed to meet them)

							</li>
						</ul>
						<hr class="divider-color" />
                        <br>
                        <p class="fs-18"><strong> Task 2: 2.1 Research and explain the type of system performed in the following countries and reasons why you think they follow these systems.
						...
						<hr class="divider-color" />
                        <br>
                        <p class="fs-18"><strong> Task 2: 2.2 You are required to assess the impact of fiscal and monetary policy on the following type of businesses
						...
						<p>
							In the housing sector, when the commercial law is applied, there also will be both active and negative influences. When the interest rates for housing are increased, it will mean that the rental charges will as well be increased. There will be few constructions taking place, and people will not invest in the sector. As a result, there will be a little revenue generation. When the rates are lowered, many people will invest in the housing sector, and many people will go for rentals as the rates would be lower. In return, the industry will be generating more income than when the interest rates are high. (Reference, and need to add more)

						</p>
						<hr class="divider-color" />
                        <br>
                        <p class="fs-18"><strong> Task 2: 2.3 You are required to identify at least five competition policy and other regulatory mechanisms in the UK and evaluate their impact on the activities of a selected organization(s).
                        ...
                        <hr class="divider-color" />
                        <br>
                        <p class="fs-18"><strong>Task 3 : 3.1 Explain how pricing and output decisions of businesses are determined in the following market structures
                        ...
                        <hr class="divider-color" />
                        <br>
                        <p class="fs-18"><strong>Task 3: 3.2 Illustrate the way in which market forces (demand and supply) shape organizational responses using a range of examples (diagrams are essential)
                        ...
                        <p>
                        	...
                        	<br>
                        	<img src="/theme/img/sample/bs1.jpg" data-at2x="/theme/img/sample/bs1.jpg" alt="Fig 1: Demand & Supply in Economy Source: Haberberg & Rieple, 2007" alt="Best Assignment Experts">
                        	<b>Fig 1: Demand & Supply in Economy Source: Haberberg & Rieple, 2007</b>
                        	<br>
                        ...
                        <hr class="divider-color" />
                        <br>
                        <p class="fs-18"><strong>Task 3 : 3.3 Judge how the business and cultural environments shape the behaviour of Sainsbury
                        ...
                        <hr class="divider-color" />
                        <br>
                        <p class="fs-18"><strong>Task 4 : 4.1 Discuss the significance of international trade to UK business organizations
                        ...
                        <p>
                        	With the political factors, this is about the change in government as well as the change in the government itself. Political factors have significantly influenced the operational business activities of various companies around the UK and have come to capture much attention in the current business environment. The organizations based in the United Kingdom, and are open to the European Union are instructed and regulated by the laws created by the European unions. The political factors can be seen to influence the spending nature of the customers and for other investments. As such, organizations need to consider the stability and political environment as well as the government legislature affecting the economy. (Reference)

                        </p>
                        <hr class="divider-color" />
                        <br>
                        <p class="fs-18"><strong>Task 4 : 4.3 Evaluate the impact of policies of the European Union on UK business organizations
                        ...
                        <ul>
                        	...
                        	<li>
                        		Werther, W. B., & Chandler, D. (2011). Strategic corporate social responsibility: Stakeholders in a global environment.Los Angeles : SAGE, [2011] ©2011


                        	</li>
                        	<li>
                        		Wolf, R., Issa, T., &Thiel, M. (2015). Empowering organizations through corporate social responsibility. Hershey : Business Science Reference, [2015].
