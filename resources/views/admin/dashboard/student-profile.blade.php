...
<div class = "alert alert-success" id="my">
  {{Session('status')}}
        ...
        <div id="register-wraper" style="margin-top: 0px;">
                <form id="register-form" class="form" method="POST" action="/student-profile/{{$id}}" enctype="multipart/form-data" >
                   <input type="hidden" name="_Token" value="{{ csrf_token() }}">
                    <legend>Profile</legend>
            <hr> <div class="body">
                             
              <label for="profile_name">Name</label>
                    <input name="profile_name" class="input-huge" type="text" value="{{$name}}">
              
            
                      <label for="profile_email">Email</label>
                      <input name="profile_email" class="input-huge" type="email" value="{{$email}}">
                      
                      <label for="profile_password">Password</label>
                      <input  name="profile_password" class="input-huge" type="password" value="{{$password}}">
              ...
              <input type="file" name="profile_image" class="input-huge" enctype="multipart/form-data" >
