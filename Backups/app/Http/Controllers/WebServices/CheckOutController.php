...
class CheckOutController extends Controller
{
    ...
    public function getChekOutResponse($assignment_id,$partial_or_full='',$apply_coupon='',$pay_through_wallet='',$call_function='')
    {
                 ...
                 if($used_coupon)
                   {
                      ...
                      return $this->getOnClickErrorResponse($assignment_id, $partial_sub_total,$partial_sub_total,$partial_or_full, $apply_coupon, $coupon_message,$show_wallet_balance,$pay_through_wallet);      
                    }  
                  ...
                  if($used_coupon)
                   {
                      ...
                      return $this->getOnClickErrorResponse($assignment_id, $partial_sub_total,$payable_amount,$partial_or_full, $apply_coupon, $coupon_message,$show_wallet_balance,$payment_using_wallet);      
                   } 
                    ...
                    $discount_value=$coupon->coupon_discount_value;
                     ...
                     {    
                         if($discount_value > $partial_sub_total)//use config::get() To set partial values
                         {
                            ...
                            $apply_coupon='false';  
                            $coupon_message='Invalid Coupon for this order!';  
                            return $this->getOnClickErrorResponse($assignment_id, $partial_sub_total,$payable_amount,0, $apply_coupon, $coupon_message,$show_wallet_balance,$payment_using_wallet);    
                     }   
      ...
      public function getOnClickErrorResponse($assignment_id, $sub_total,$payable_amount,$partial_or_full, $apply_coupon, $coupon_message,$show_wallet_balance,$payment_using_wallet='',$coupon_discount_value='')
    {
          $response = new SendResponseController();
