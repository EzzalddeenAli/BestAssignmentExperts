        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                ...
                <div class="register-info-wraper">
                    <div id="register-info">
                        <div class="cont2">
                            <div class="thumbnail">
                                <img src="https://www.hostgatordiscountcoupon.com/wp-content/uploads/2012/06/animatedcoupon.gif" alt="Marcel Newman" class="img-circle">
                            </div><!-- /thumbnail -->
                            <h2>Coupons Details</h2>
                        </div>
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="cont3" style="text-align: center;">
            ...
            <div class="col-sm-6 col-lg-6">
                <div id="register-wraper">
                    <form id="register-form" class="form" methbod="POST" action="/post-coupon-data" style="margin-top: -50px">
