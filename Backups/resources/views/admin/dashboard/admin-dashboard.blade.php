      ...
      <!-- USER PROFILE BLOCK -->
        ...
        <a href="/on-my-profile/{{Auth::user()->id}}">
      		<div class="dash-unit">
	      		...
	      		<hr>
				<div class="thumbnail">
					<img src="../dashboard_theme/dist/img/graduate.png" alt="Marcel Newman" class="img-circle" style="width: 100px">
				</div><!-- /thumbnail -->
        ...
        <div class="col-sm-3 col-lg-3">
            <div class="dash-unit">
	      		...
	      		<div class="cont">
					...
					<br>
					<p><img src="../admin-dashboard/images/up-small.png" alt=""> </p>
	  ...
	  <!-- 30 DAYS STATS - CAROUSEL FLEXSLIDER -->     
        <div class="col-sm-3 col-lg-3">
			...
			<a href="/show-experts"><div class="half-unit">
      			...
      			<p><img src="../admin-dashboard/images/up-small.png" alt=""> {{$new_expert_request}} Expert Requests   </p>
	      		</div>
			</div></a>
			...
			<a href="/show-students"><div class="half-unit">
      			...
      			<p><img src="../admin-dashboard/images/up-small.png" alt=""> {{$new_student_request}} New Students   </p>
	      		</div>
			</div></a>
        </div>
      </div><!-- /row -->
...
">
	      ...
	      <div class="dash-unit">
	            ...
	            <div class="flexslider">
					<ul class="slides">
						<li><img src="../admin-dashboard/images/slide01.png" alt="slider"></li>
						<li><img src="../admin-dashboard/images/slide02.png" alt="slider"></li>
					</ul>
            </div>
				<div class="cont">
					<p></p>
