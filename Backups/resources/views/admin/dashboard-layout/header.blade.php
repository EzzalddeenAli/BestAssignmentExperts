        ...
        <div class="navbar-header">
          ...
          <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
              ...
              <li> <form action="/search-admin-student-id" method="get" class="form-padding"> 
                    {{ csrf_field() }}
                    <div>
                        <input  id="value" type="text" name="search_student_id" class="form-control" />
                    </div>
                    <div class="search-button">
...
<!--              <li> <form action="/search-admin-student/" method="get" class="form-padding"> 
                    {{ csrf_field() }}
                    <div >
