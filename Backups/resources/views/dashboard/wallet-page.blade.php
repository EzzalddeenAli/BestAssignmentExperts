...
<!--   <input type="hidden" name="amount" value="1">
 -->  <input type="hidden" name="currency_code" value="USD">
  ...
  <input type="hidden" name="cancel_return" value="http://bestassignmentexperts.com/paypal-wallet-amount-cancel">
  <input type="hidden" name="return" value="http://bestassignmentexperts.com/paypal-wallet-amount-success">
