...
<!--              <img class="profile-user-img img-responsive img-circle" src="../dashboard_theme/dist/img/graduate.png" alt="User profile picture">-->
        ...
        <div class="col-md-8">
          ...
          <!-- /.info-box -->
                 ...
                 <form action="/update-profile" method="POST" class="form-horizontal" enctype="multipart/form-data">
...
<!--                  <div class="form-group">
                  ...
                  <div class="form-group">
                    <label for="inputSkills"  class="col-sm-3 control-label">About Myself</label>

                    <div class="col-sm-9">
                      <input type="text" name = "about_me" value="{!! $results->about_me !!}" class="form-control" id="inputSkills" placeholder="Skills" >
                    </div>
                  </div>
