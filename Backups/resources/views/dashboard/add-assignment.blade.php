                    ...
                    <form action="<?= URL::to('/put/assignment/data') ?>" name="add-assignment" method="POST" class="form-horizontal" enctype="multipart/form-data">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <label for="Date"  class="col-sm-2 control-label">Due Date</label>
...
">
                            ...
                            <div class="form-group">
                                ...
                                <label for="inputEmail3" class="col-sm-2 control-label">No of Pages</label>
                            ...
                            <div class="form-group">
                                ...
                                <label for="Minimal" class="col-sm-2 control-label">Reference Style</label>
                            ...
                            <div class="form-group">
                                ...
                                <label for="UploadAssignment" class="col-sm-2 control-label">Upload Assignment 1</label>
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <div class="input-group date">
                                        ...
                                        <input type="file" required="" name="uploaded_file1" id="UploadAssignment1" class="form-control" placeholder="Browse Assignment" style="

                                               height: 50px;

                                               background: #f39c12;cursor:pointer;border-right:none;
                            ...
                            <div class="form-group">
                                ...
                                <label for="UploadAssignment" class="col-sm-2 control-label">Upload Assignment 2</label>
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <div class="input-group date">
                                        ...
                                        <input type="file" name="uploaded_file2" id="UploadAssignment2" class="form-control" placeholder="Browse Assignment" style="
                            ...
                            <div class="form-group">
                                ...
                                <label for="UploadAssignment" class="col-sm-2 control-label">Upload Assignment 3</label>
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <div class="input-group date">
                                        ...
                                        <input type="file" name="uploaded_file3" id="UploadAssignment3" class="form-control" placeholder="Browse Assignment" style="
                            ...
                            <div class="box-footer">
                                ...
                                <button class="btn btn-default cancel-request">Cancel</button>
